...
interface string2AnyMap {
  ...
  */
  ...
  declare interface UserInfoButton {
	destroy(): void;
	hide(): void;
	onTap(callback: ({ errMsg: string, userInfo: UserInfo, rawData: string, signature: string, encryptedData: string, iv: string }) => void): void;
